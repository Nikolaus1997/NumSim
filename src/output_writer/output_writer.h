...
public:
  ...
  OutputWriter(std::shared_ptr<LbmDiscretization> discretization);
...
protected:
  ...
  std::shared_ptr<LbmDiscretization> discretization_;  //< a shared pointer to the discretization which contains all data that will be written to the file
