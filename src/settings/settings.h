...
struct Settings
{
  std::array<int,2> nCells{50,10};          //< number of cells in x and y direction
  ...
  std::array<double,2> dirichletBcLeft{2./3.*0.1,0.};    //< prescribed values of u,v at left of domain
