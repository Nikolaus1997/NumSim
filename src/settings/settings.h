...
struct Settings
{
  std::array<int,3> nCells{20,20,20};          //< number of cells in x and y direction
  ...
  std::array<double,3> dirichletBcTop{0.2,0.,0.};     //< prescribed values of u,v at top of domain
