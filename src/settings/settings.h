...
struct Settings
{
  ...
  double re =500.;                 //< reynolds number
  double endTime = 2000.0;             //< end time of the simulation
  ...
  std::array<double,2> dirichletBcTop{.8,0.};     //< prescribed values of u,v at top of domain
